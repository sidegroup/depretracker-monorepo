class UserFilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_file.save
        format.html { redirect_to user_files_url, notice: "Arquivo criado com sucesso" }
  ...
  def update
    respond_to do |format|
      if @user_file.update(user_file_params)
        format.html { redirect_to user_files_url, notice: "Arquivo atualizado com sucesso" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_files_url, notice: "Arquivo deletado com sucesso" }
